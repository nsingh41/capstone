...
.mce-panel{
  background-color: #763249;
   ...
   <!--Navigation Bar -->
    ...
    <a href="see_posts.php" class="navbar-brand d-flex mr-auto font-head logo" style=""> 
...
<ul class="nav navbar-nav ml-auto justify-content-end nav-btn">
                <li class="nav-item">
					<span class="nav-link">
                    <a href="login_form.php"><button type="button" id="button" class="btn custom-sign"><i class="fas fa-sign-in-alt"></i>
